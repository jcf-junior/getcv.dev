...
export default function Toolbar({
  ...
  return (
    <div className="fixed bottom-10 mx-auto flex gap-5 w-fit justify-center items-center bg-white rounded-full px-2 py-2 border border-slate-200 shadow-lg z-9999">
      <div className="bg-white flex items-center justify-center text-gray-100">
        <button
        ...
        <input
          ...
          className="w-[45px] text-slate-500 font-bold px-1 text-center focus:outline-none text-xs"
          onKeyDown={(e) => {
            if (e.key == "Enter") {
